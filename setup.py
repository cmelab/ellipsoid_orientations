...
# Package meta-data.
NAME = 'ellipsoid_orientations'
DESCRIPTION = 'Ellipsoid orientations'
URL = 'https://github.com/cmelab/ellipsoid_orientations.git'
EMAIL = 'marjanalbooyeh@boisestate.edu'
